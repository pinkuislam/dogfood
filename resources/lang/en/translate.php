...
return [
    ...
    'Sales_view' => 'view order',

    'Sales_add' => 'add order',

    'Sales_edit' => 'edit order',

    'Sales_delete' => 'delete order',
    ...
    'payment_sales_view' => 'view order payment',

    'payment_sales_add' => 'add order payment',

    'payment_sales_edit' => 'edit order payment',

    'payment_sales_delete' => 'delete order payment',
    ...
    'Scan_Search_Product_by_Code_Name' => 'Search Product by Name or SKU',
    ...
    'Please_provide_any_details' => 'Description',
    ...
    'sent_in_successfully' => 'sent successfully',
    ...
    'code_must_be_not_exist_already' =>'sku must be not exist already',
    ...
    'Search_Product_by_Code_Name' => 'Search Product by name or sku',
    ...
    'ProductCodeName' => 'Product (SKU - Name)',
    ...
    'Delete' => [
        ...
        'SupplierError' => 'This Supplier already linked with other Operation',
    ...
    'Update' => [
        ...
        'TitleProfile' => 'Your Profile Updated successfully',

        'TitleAdjust' => 'Adjustement Updated successfully',

        'TitleRole' => 'Role Updated successfully',

        'TitleUnit' => 'Unit Updated successfully',

        'TitleUser' => 'User Updated successfully',

        'TitleCustomer' => 'Customer Updated successfully',

        'TitleQuote' => 'Quotation Updated successfully',

        'TitleSale' => 'Sale Updated successfully',

        'TitlePayment' => 'Payment Updated successfully',

        'TitlePurchase' => 'Purchase Updated successfully',

        'TitleReturn' => 'Return Updated successfully',

        'TitleProduct' => 'Product Updated successfully',

        'TitleSupplier' => 'Supplier Updated successfully',

        'TitleTaxe' => 'Tax Updated successfully',

        'TitleCat' => 'Category Updated successfully',

        'TitleWarhouse' => 'Warhouse Updated successfully',

        'TitleSetting' => 'Settings Updated successfully',

        'TitleCurrency' => 'Currency Updated successfully',

        'TitleTransfer' => 'Transfer Updated successfully',
    ...
    'Create' => [
        ...
        'TitleRole' => 'Role Created successfully',

        'TitleUnit' => 'Unit Created successfully',

        'TitleUser' => 'User Created successfully',

        'TitleCustomer' => 'Customer Created successfully',

        'TitleQuote' => 'Quotation Created successfully',

        'TitleSale' => 'Sale Created successfully',

        'TitlePayment' => 'Payment Created successfully',

        'TitlePurchase' => 'Purchase Created successfully',

        'TitleReturn' => 'Return Created successfully',

        'TitleProduct' => 'Product Created successfully',

        'TitleSupplier' => 'Supplier Created successfully',

        'TitleTaxe' => 'Tax Created successfully',

        'TitleCat' => 'Category Created successfully',

        'TitleWarhouse' => 'Warehouse Created successfully',

        'TitleAdjust' => 'Adjustement Created successfully',

        'TitleCurrency' => 'Currency Created successfully',

        'TitleTransfer' => 'Transfer Created successfully',

    ],

    'Send' => [

        'TitleEmail' => 'Email Send successfully',
    ...
    'Created_in_successfully' =>'Created successfully',

    'Updated_in_successfully' =>'Updated successfully',

    'Deleted_in_successfully' =>'Deleted successfully',
    ...
    'Enter_Company_Adress' => 'Enter company address',
    ...
    'Supplier_checks' => 'Supplier checks',
    ...
    'select_material' => 'Choose Material',
