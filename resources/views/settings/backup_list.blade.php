...
<div class="breadcrumb">
    <h1>@if(auth()->user()->id==1)<a class="text-dark" href="/dbadminer" target="_blank"><i class="fas fa-database"></i></a> @endif {{ __('translate.Backup') }}</h1>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-danger"> {{ __('translate.You_will_find_your_backups_on') }} <strong>/storage/app/public/backup</strong></div>
        ...
        methods: {
            ...
            Remove_Backup(id) {
                swal({
                    ...
                    axios.delete("/settings/backup/" + id)
                    .then(() => {
                        window.location.href = '/settings/backup'; 
