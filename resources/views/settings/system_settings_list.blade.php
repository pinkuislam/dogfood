          ...
          <form @submit.prevent="Update_Settings()" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                  ...
                  <v-select placeholder="{{ __('translate.Default_Language') }}" v-model="setting.default_language" :reduce="(option) => option.value" :options="[{label: 'English', value: 'en'}]">
                  </v-select>
          ...
          <form @submit.prevent="Update_Email_Settings()" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <v-select placeholder="{{ __('translate.MAIL_MAILER') }}" v-model="email_settings.mailer" :reduce="(option) => option.value" :options="[{label: 'SMTP', value: 'smtp'},{label: 'PHP Mail', value: 'sendmail'},{label: 'Log', value: 'log'},{label: 'Mailgun', value: 'mailgun'},{label: 'SES', value: 'ses'},{label: 'Postmark', value: 'postmark'}]">
                </v-select>
              ...
              <div class="form-group col-md-4">
                ...
                <v-select placeholder="{{ __('translate.Mail_Encryption') }}" v-model="email_settings.encryption" :reduce="(option) => option.value" :options="[{label: 'tls', value: 'tls'},{label: 'ssl', value: 'tls'}]">
                </v-select>
          ...
          <div class="card-body">
            <form @submit.prevent="Update_Backup_Settings()" enctype="multipart/form-data">
              ...
              <div class="row mt-3 d-none">
                <div class="col-md-12">
                    <ul>
                      ...
                      <li><strong>{{ __('translate.Wamp') }} :</strong> C:\wamp\bin\mysql\mysql5.7.40\bin\mysqldump.exe </li>
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-6">
                  <button type="submit" class="btn btn-primary"> <i class="far fa-check-circle me-2 font-weight-bold"></i> {{ __('translate.Submit') }}
                  </button>
                </div>
              </div>
            </form>
            ...
            <div class="row">
              ...
              <button type="submit" class="btn btn-primary" :disabled="Submit_Processing_Clear_Cache">
                <span v-if="Submit_Processing_Clear_Cache" class="spinner-border spinner-border-sm" role="status"
                  aria-hidden="true"></span> <i class="far fa-check-circle me-2 font-weight-bold"></i> {{ __('translate.Clear_Cache') }}
              </button>
            </div>
            </div>
          </form>
