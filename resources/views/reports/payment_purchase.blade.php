    ...
    $(function () {
      ...
      $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
            ...
            $('#payment_purchase_table').DataTable().destroy();
                payment_purchase_datatable(start_date, end_date, Ref, supplier_id , payment_method_id, warehouse_id, account_id);
        ...
        //Get Data
        function payment_purchase_datatable(start_date ='', end_date ='', Ref ='', supplier_id ='',  payment_method_id ='', warehouse_id ='', account_id =''){
