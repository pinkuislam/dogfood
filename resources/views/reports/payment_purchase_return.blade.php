    ...
    <div class="col-md-12">
        <div class="text-left">
            <div class="text-end bg-transparent mb-3">
                ...
                <a class="btn btn-outline-primary btn-rounded btn-md m-1" id="Show_Modal_Filter"><i class="fas fa-filter mr-2 font-weight-bold"></i>
                 ...
                 <div class="modal-body">
                     ...
                     <form method="POST" id="filter_payment_purchase_return">
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                 <label for="supplier_id" class="ul-form__label">{{ __('translate.Supplier') }}
                                 </label>
                         ...
                         <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-primary">
                                  <i class="fas fa-filter mr-2"></i> {{ __('translate.Filter') }}
                                </button>
                                <button id="Clear_Form" class="btn btn-danger">
                                  <i class="fas fa-power-off mr-2"></i> {{ __('translate.Clear') }}
                                </button>
                              </div>
                         </div>
...
<script type="text/javascript">
    $(function () {
      ...
      $(document).ready(function () {
        ...
        //Get Data
        function payment_purchase_return_datatable(start_date ='', end_date ='', Ref ='', supplier_id ='', purchase_return_id ='' , payment_method_id ='', account_id =''){
        ...
        $('#filter_payment_purchase_return').on('submit' , function (e) {
            ...
            payment_purchase_return_datatable(start_date, end_date, Ref, supplier_id, purchase_return_id , payment_method_id, account_id);
