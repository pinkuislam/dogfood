...
<script type="text/javascript">
  $(function () {
      ...
      $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
            ...
            purchase_datatable(start_date, end_date, Ref, supplier_id ,warehouse_id , payment_statut);
        ...
        //Get Data
        function purchase_datatable(start_date ='', end_date ='', Ref ='',supplier_id ='',warehouse_id ='', payment_statut =''){
