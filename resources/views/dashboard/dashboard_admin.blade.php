      ...
      <div class="col-lg-6 col-md-12 mb-4">
        <div class="card p-4 d-flex flex-row align-items-center justify-content-between">
          <div>
            ...
            {{ __('translate.hi') }}, {{Auth::user()->username}}!
            </p>
            <p class="p-0 m-0 text-gray-600 font_14">
              {{ __('translate.todays_overview') }}
            </p>
...
@else
  <h4>{{ __('translate.hi') }} , {{ Auth::user()->username }}</h4>
@endif
@endsection

@section('page-js')
<script src="{{ asset('assets/vendor/datatables.min.js') }}"></script>
<script src="{{ asset('assets/vendor/daterangepicker.min.js') }}"></script>
<script src="{{ asset('assets/vendor/echarts.min.js') }}"></script>
<script src="{{ asset('assets/vendor/echart.options.min.js') }}"></script>
