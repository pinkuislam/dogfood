        ...
        <div class="col-md-12">
          <div class="text-end mb-3">
            ...
            <a class="btn btn-outline-success btn-md m-1" id="Show_Modal_Filter"><i
                class="fas fa-filter me-2 font-weight-bold"></i>
...
<script type="text/javascript">
  $(function () {
      ...
      $(document).ready(function () {
        ...
        //Get Data
        function return_purchase_datatable(start_date ='', end_date ='', Ref ='',supplier_id ='', payment_statut ='', warehouse_id ='', purchase_id =''){
        ...
        $('#filter_purchase_return').on('submit' , function (e) {
            ...
            return_purchase_datatable(start_date, end_date, Ref, supplier_id, payment_statut, warehouse_id, purchase_id);
