...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/themes/login_page.css') }}">
                ...
                <div class="login-main">
                    ...
                    <form class="theme-form" id="form_login" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <input class="form-control" type="email" placeholder="" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                              @if ($errors->has('email'))
