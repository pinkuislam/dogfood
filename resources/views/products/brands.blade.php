    ...
    <div class="card">
      <div class="card-body">
        <div class="text-end mb-3">
          <a class="new_brand btn btn-outline-primary btn-md m-1"><i class="fas fa-plus-circle me-2 font-weight-bold"></i>
...
<script>
  var app = new Vue({
          ...
          methods: {
              ...
              Get_Data_Edit(id) {
                  axios
                  .get("{{ url('products/brands') }}/"+id+"/edit")
                  .then(response => {
              ...
              Create_Brand() {
                  ...
                  axios
                      .post("{{ url('products/brands') }}", self.data)
                      .then(response => {
             ...
             //---------------------------------------- Update Brand-----------------\\
              Update_Brand() {
                  ...
                  axios
                      .post("{{ url('products/brands') }}/" + self.brand.id, self.data)
                      .then(response => {
                          self.SubmitProcessing = false;
                          $.event.trigger('event_brand');
