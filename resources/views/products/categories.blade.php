          ...
          <form @submit.prevent="editmode?Update_Category():Create_Category()" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-12">
                ...
                <label for="type">{{ __('translate.type') }}<span class="field_required">*</span></label>

                <input type="text" v-model="category.type" class="form-control" name="type" id="type"

                  placeholder="{{ __('translate.enter_type') }}">
              ...
              <div class="form-group col-md-12">
                ...
                <label for="lavel">{{ __('translate.lavel') }}<span class="field_required">*</span></label>

                <input type="number" v-model="category.lavel" class="form-control" name="lavel" id="lavel"

                  placeholder="{{ __('translate.enter_lavel') }}">

                <span class="error" v-if="errors && errors.lavel">
