    ...
    <div class="card">
      <div class="card-body">
        <div class="text-end mb-3">
          <a class="new_unit btn btn-outline-primary btn-md m-1"><i class="fas fa-plus-circle me-2 font-weight-bold"></i>
...
<script>
  Vue.component('v-select', VueSelect.VueSelect)
        ...
        methods: {
            ...
            Get_Data_Edit(id) {
                axios
                .get("{{ url('products/units') }}/"+id+"/edit")
                .then(response => {
            ...
            Update_Unit(){
                ...
                self.SubmitProcessing = true;
                self.setToStrings();
                axios.put("{{ url('products/units') }}/" + self.unit.id, {
                    name: self.unit.name,
                    ShortName: self.unit.ShortName,
                    base_unit: self.unit.base_unit,
                    operator: self.unit.operator,
            ...
            Remove_Unit(id) {
                swal({
                    ...
                    axios.delete("{{ url('products/units') }}/" + id)
                    .then(response => {
