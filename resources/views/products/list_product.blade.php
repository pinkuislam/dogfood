    ...
    <div class="card">
      <div class="card-body">
        <div class="text-end mb-3">
          @can('products_add')
          <a href="{{ url('products/products/create') }}" class=" btn btn-outline-primary btn-md m-1"><i class="fas fa-plus-circle me-2 font-weight-bold"></i>
          ...
          <form method="POST" id="filter_products">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="sku">{{ __('translate.Code_Product') }}
                </label>
...
<script type="text/javascript">
  $(function () {
      ...
      $(document).ready(function () {
        ...
        //Get Data
        function product_datatable(name ='', category_id ='',brand_id ='', sku =''){
        ...
        $('#filter_products').on('submit' , function (e) {
            ...
            product_datatable(name, category_id, brand_id, sku);
        ...
        methods: {
            ...
            Remove_product(id) {
                swal({
                    ...
                    axios
                    .delete("{{ url('products/products') }}/" + id)
                    .then(() => {
