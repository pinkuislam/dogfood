    ...
    <div class="card">
      <div class="card-body">
        <div class="text-end  mb-3">
          <a class="new_Warehouse btn btn-outline-primary btn-md m-1"><i class="fas fa-plus-circle me-2 font-weight-bold"></i>
...
<script>
  var app = new Vue({
        ...
        methods: {
            ...
            Get_Data_Edit(id) {
                axios
                .get("{{ url('products/warehouses') }}/"+id+"/edit")
                .then(response => {
           ...
           Update_Warehouse() {
                ...
                self.SubmitProcessing = true;
                axios
                    .put("{{ url('products/warehouses') }}/" + this.warehouse.id, {
                        name: this.warehouse.name,
                        mobile: this.warehouse.mobile,
                        email: this.warehouse.email,
                        zip: this.warehouse.zip,
             ...
             Remove_warehouse(id) {
                ...
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                            .delete("{{ url('products/warehouses') }}/" + id)
                            .then(() => {
                                $.event.trigger('event_warehouse');
