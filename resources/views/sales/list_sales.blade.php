      ...
      <div class="card">
        <div class="card-body">
          <div class="text-end bg-transparent mb-3">
            <a class="btn btn-outline-success btn-rounded btn-md m-1" id="Show_Modal_Filter"><i class="fas fa-filter me-2 font-weight-bold"></i> {{ __('translate.Filter') }}</a>
          </div>
          ...
          <div class="table-responsive">
            <table id="sale_table" class="display table table-hover">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>{{ __('translate.wooID') }}</th>
                  <th>{{ __('translate.Customer') }}</th>
                  <th>{{ __('translate.date') }}</th>
                  <th>{{ __('translate.Status') }}</th>
                  <th>{{ __('translate.Total') }}</th>
                  <th>{{ __('translate.PackingList') }}</th>
