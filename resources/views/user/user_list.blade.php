      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="text-end mb-3">
            <a class="new_user btn btn-outline-primary btn-md m-1" @click="New_User"><i class="fas fa-plus-circle me-2 font-weight-bold"></i></i>
  ...
  Vue.component('v-select', VueSelect.VueSelect)
        ...
        methods: {
            ...
            reset_Form() {
             ...
             Get_Data_Create() {
                axios
                    .get("{{ url('user-management/users/create') }}")
                    .then(response => {
               ...
               Get_Data_Edit(id) {
                axios
                    .get("{{ url('user-management/users') }}/"+id+"/edit")
                    .then(response => {
            ...
            assignRole(user_id , role_id) {
                var self = this;
                axios.post("{{ url('user-management/assignRole') }}", {
                    user_id: user_id,
                    role_id: role_id,
                }).then(response => {
                       window.location.href = "{{ url('user-management/users') }}"; 
            ...
            Create_User() {
                ...
                axios
                    .post("{{ url('user-management/users') }}", self.data)
                    .then(response => {
           ...
           //----------------------- Update User ---------------------------\\
            Update_User() {
                ...
                axios
                    .post("{{ url('user-management/users') }}/" + this.user.id, self.data)
                    .then(response => {
                        self.SubmitProcessing = false;
            ...
            Remove_User(id) {
                ...
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                            .delete("{{ url('user-management/users') }}/" + id)
                            .then(() => {
                              window.location.href = "{{ url('user-management/users') }}"; 
