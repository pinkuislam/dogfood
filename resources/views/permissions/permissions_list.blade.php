      ...
      <div class="card-body">
        <div class="text-end mb-3">
          ...
          <a class="btn btn-outline-primary btn-md m-1" href="{{route('permissions.create')}}"><i
              class="fas fa-plus-circle me-2 font-weight-bold"></i> {{ __('translate.Create') }}</a>
        </div>
          ...
          <table id="permissions_table" class="display table">
            ...
            <tbody>
              ...
              <tr>
                ...
                @else
                <td>
                  <a href="{{ url('user-management/permissions/'.$role->id.'/edit') }}" class="cursor-pointer text-success ul-link-action"
             ...
             Remove_role(id) {
                ...
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                            .delete("{{ url('user-management/permissions') }}/" + id)
                            .then(() => {
                                window.location.href = "{{ url('user-management/permissions') }}"; 
