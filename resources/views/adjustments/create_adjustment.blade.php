                      ...
                      <tr v-for="detail in details" :key="detail.detail_id">
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <input class="fw-semibold cart-qty m-0 px-2" @keyup="Verified_Qty(detail,detail.detail_id)" :min="0.00" :max="detail.current" v-model.number="detail.quantity">
        ...
        methods: {  
            ...
            Create_Adjustment() {
                if (this.verifiedForm()) {
                    ...
                    NProgress.set(0.1);
                    axios
                    .post("{{ url('adjustment/adjustments') }}", {
