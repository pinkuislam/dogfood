        ...
        <div class="card">
          <div class="card-body">
            <div class="text-end bg-transparent mb-3">
              @can('adjustment_add')
              <a href="{{ url('adjustment/adjustments/create') }}" class="btn btn-outline-primary btn-md m-1"><i class="fas fa-plus-circle me-2 font-weight-bold"></i>
             ...
             Remove_Adjustment(id) {
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                            .delete("{{ url('adjustment/adjustments') }}/" + id)
                            .then(() => {
