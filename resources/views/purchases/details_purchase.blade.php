...
<div class="row" id="section_purchase_detail">
  <div class="col-md-12 mb-5">
        ...
        @can('purchases_edit')
          <a  v-if="purchase.purchase_has_return == 'no'" class="btn-sm btn btn-success btn-icon m-1" :href="'{{ url('purchase/purchases') }}/'+purchase.id+'/edit'">
        ...
        <a @click="Print_Purchase_PDF(purchase.id)" class="btn-sm btn btn-secondary ripple btn-icon m-1">
          <i class="far fa-file-pdf"></i> {{ __('translate.Download_PDF') }}
        </a>
              ...
              <table class="table table-hover table-md">
                <thead class="bg-gray-300">
                  <tr>
                    ...
                    <th scope="col">{{ __('translate.SKU') }}</th>
...
<script>
  function printDiv() {
    ...
    printWindow.document.write(
      '<link rel="stylesheet"  href="/assets/styles/vendor/bootstrap.css"><html>'
    );
          ...
          buttonsStyling: false
              ...
              axios
                  ...
                  .then(() => {
                      ...
                      window.location.href = "{{ url('purchase/purchases') }}";
                  })
                  .catch(() => {
                      toastr.error('{{ __('translate.There_was_something_wronge') }}');
                  });
