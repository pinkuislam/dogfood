                  ...
                  <table class="table table-hover table-md">
                    ...
                    <tbody>
                      ...
                      <tr v-for="detail in details">
                        ...
                        <td>
                          <a @click="Modal_Update_Detail(detail)" class="cursor-pointer ul-link-action text-success"
                            title="Edit">
        ...
        methods: {
            ...
            Update_Detail() {
                ...
                for (var i = 0; i < this.details.length; i++) {
                    ...
                    if (this.details[i].detail_id === this.detail.detail_id) {
                        ...
                        this.details[i].Net_cost = this.detail.Net_cost = this.detail.Unit_cost;
            ...
            Update_Purchase() {
              if (this.verifiedForm()) {
                ...
                NProgress.set(0.1);
                axios
                .put("{{ url('purchase/purchases') }}/"+ this.purchase.id, {
