...
class Notifications_Template extends Controller
{
    ...
    public function get_sms_template(Request $request)
    {
        ...
        $user_auth = auth()->user();
		if ($user_auth->can('notification_template')){
            ...
            return view('settings.sms_template', compact('sms_body_sale','sms_body_quotation','sms_body_payment_received','sms_body_purchase','sms_body_payment_sent'));
    ...
    public function get_emails_template(Request $request)
    {
		...
		if ($user_auth->can('notification_template')){
            ...
            return view('settings.emails_template', compact('sale','quotation','payment_received','purchase','payment_sent'));
