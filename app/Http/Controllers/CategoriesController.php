...

{
...

    {
		...
		if ($user_auth->can('category')){
            ...
            if ($request->ajax()) {
                ...
                $data = Category::with('parent', 'childs')->where('deleted_at', '=', null)->orderBy('id', 'desc')->get();

                return Datatables::of($data)->addIndexColumn()

                ->addColumn('parent', function ($data) {
                    return $data->parent ? $data->parent->name: __("translate.Parent");
                })
...

    {
		...
		if ($user_auth->can('category')){
            ...
            $results = Category::where('deleted_at', null)
